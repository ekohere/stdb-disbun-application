...
//     $('#standar_table').DataTable().search(
//         $('#global_filter').val()
//     ).draw();
// }
...
$(document).ready(function() {
    ...
    $('.buttons-copy').addClass('btn btn-sm btn-secondary mr-1');
    $('.buttons-csv').addClass('btn btn-sm btn-primary mr-1');
    $('.buttons-excel').addClass('btn btn-sm btn-success mr-1');
    $('.buttons-pdf').addClass('btn btn-sm btn-info mr-1');
    $('.buttons-print').addClass('btn btn-sm btn-danger mr-1');
