...
var functionMap = {
    ...
    "com_create_guid": [
        ...
        "Generator a globally unique identifier (GUID)"
    ],
    "com_event_sink": [
    ...
    "hash": [
        ...
        "Generator a hash of a given input string Returns lowercase hexits by default"
    ],
    "hash_algos": [
    ...
    "hash_file": [
        ...
        "Generator a hash of a given file Returns lowercase hexits by default"
    ],
    "hash_final": [
    ...
    "hash_hmac": [
        ...
        "Generator a hash of a given input string with a key using HMAC Returns lowercase hexits by default"
    ],
    "hash_hmac_file": [
        "string hash_hmac_file(string algo, string filename, string key[, bool raw_output = false])",
        "Generator a hash of a given file with a key using HMAC Returns lowercase hexits by default"
    ],
    "hash_init": [
    ...
    "posix_ctermid": [
        ...
        "Generator terminal path name (POSIX.1, 4.7.1)"
    ],
    ...
    "syslog": [
        ...
        "Generator a system log message"
    ],
    "system": [
