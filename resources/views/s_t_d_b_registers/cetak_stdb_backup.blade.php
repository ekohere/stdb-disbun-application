...
<div class="page" id="halaman">
    ...
    <div class="col-sm-12 pl-5 mt-1 isi_surat">
        ...
        @endforeach
        <h5 class="isi_surat">STD-B ini tidak berlaku apabila terjadi perubahan terhadap informasi tersebut diatas.</h5>
...
<div class="page">
    ...
    <div class="col-sm-12 pl-5 mt-1 isi_surat">
        ...
        <br>
        <img width="60%" src="{!! asset('image/example-shm.jpeg') !!}">
