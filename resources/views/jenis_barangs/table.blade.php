        ...
        <tr>
            ...
            <td>
                ...
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="{!! route('jenisBarangs.show', [$jenisBarang->id]) !!}" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a>
                                       <a href="{!! route('jenisBarangs.edit', [$jenisBarang->id]) !!}" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i></a>
