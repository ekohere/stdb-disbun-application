                                ...
                                <div class="row">
                                    <div class="col-10 media-body mb-2">
                                        <div class="content-header-left breadcrumb-new">
                                            <span class="content-header-title mb-0 d-inline-block font-medium-4"><b>S T D B Statuses</b></span>
                                    ...
                                    <div class="col-2 text-right">
                                        <a href="{!! route('sTDBStatuses.create') !!}" class="btn btn-sm btn-green">Tambah Data</a>
                                    </div>
                                </div>
                                @include('s_t_d_b_statuses.table')
                            </div>
                        </div>
                    </div>
                </div>
