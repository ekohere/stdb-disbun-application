            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::number('no_hp', null, ['class' => 'form-control border-left-pink border-left-6 text-bold-600 black font-medium-2']) !!}
                    </div>
                </div>
                <div class="col-6">
                    <!-- Email Field -->
                ...
                <div class="col-12">
                    <!-- Alamat Field -->
                    <div class="form-group">
                        {!! Form::label('alamat', 'Alamat Lengkap Tempat Tinggal',['class'=>' text-uppercase']) !!}
                        {!! Form::textarea('alamat', null, ['class' => 'form-control border-left-pink border-left-6 text-bold-600 black font-medium-2','rows'=>'3','maxlength'=>'255']) !!}
                    </div>
